...
//! @{
//! \file ddi_nand_gpmi_dma.h
//! \brief DMA structures and prototypes for GPMI driver.
//!
//! This file includes the structures created for each
//! DMA chain and the defines and prototypes required for
//! each one.
///////////////////////////////////////////////////////////////////////////////
#ifndef _NAND_DMA_H
#define _NAND_DMA_H
...
typedef struct _apbh_dma_gpmi3_t
{
    ...
    union                                           // PIO commands to write to HW_GPMI_CTRLm and
    {                                               // subsequent hardware registers.
        struct
        {
...
#if !defined(__ghs)
#pragma mark -NAND DMA Components-
#endif
...
namespace NandDma
{
    ...
    namespace Component
    {
        ...
        public:
            ...
            //! \brief Component initializer.
            void init(unsigned chipSelect, void * dataBuffer, void * auxBuffer, uint32_t readSize, const NandEccDescriptor_t & ecc, uint32_t eccMask);
            
            //! \brief Change only the chip select number.
            void setChipSelect(unsigned chipSelect);
            
            //! \brief Update buffers.
            void setBufferAndSize(void * dataBuffer, void * auxBuffer, uint32_t readSize, const NandEccDescriptor_t & ecc, uint32_t eccMask);
        ...
        public:
            ...
            //! \brief Component initializer.
            void init(unsigned chipSelect, const void * dataBuffer, const void * auxBuffer, uint32_t sendSize, uint32_t dataSize, uint32_t leftoverSize, const NandEccDescriptor_t & ecc, uint32_t eccMask);
            ...
            //! call this method.
            void setBufferAndSize(const void * dataBuffer, const void * auxBuffer, uint32_t sendSize, uint32_t dataSize, uint32_t leftoverSize, const NandEccDescriptor_t & ecc, uint32_t eccMask);
